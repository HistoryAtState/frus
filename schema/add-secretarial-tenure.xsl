            ...
            <xsl:element name="keywords" namespace="http://www.tei-c.org/ns/1.0">
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'seward-william-henry')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1861-1869</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'washburne-elihu-benjamin')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1869-1869</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'fish-hamilton')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1869-1877</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'evarts-william-maxwell')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1877-1881</xsl:attribute>United States.
                ...
                <xsl:if
                    ...
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1881-1885</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'bayard-thomas-francis')]">
                    ...
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1881-1881</xsl:attribute>United States.
                        Department of State. Secretary (1881-1881 : Bayard, Thomas
                        Francis)</xsl:element>
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1885-1889</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'blaine-james-gillespie')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1889-1892</xsl:attribute>United States.
                        Department of State. Secretary (1889-1892 : Gillespie, Blaine
                        James)</xsl:element>
                </xsl:if>
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'foster-john-watson')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1892-1893</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'gresham-walter-quintin')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1893-1895</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'olney-richard')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1895-1897</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'sherman-john')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1897-1898</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'day-william-rufus')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1898-1898</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'hay-john-milton')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1898-1905</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'root-elihu')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1905-1909</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'knox-philander-chase')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1909-1909</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'knox-philander-chase')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1909-1913</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'bryan-william-jennings')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1913-1915</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'lansing-robert')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1915-1920</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'colby-bainbridge')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1920-1921</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'hughes-charles-evans')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1921-1925</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'kellogg-frank-billings')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1925-1929</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'stimson-henry-lewis')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1929-1933</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'hull-cordell')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1933-1944</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'stettinius-edward-reilly')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1944-1945</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'byrnes-james-francis')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1945-1947</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'marshall-george-catlett')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1947-1949</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'acheson-dean-gooderham')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1949-1953</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'dulles-john-foster')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1953-1959</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'herter-christian-archibald')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1959-1961</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'rusk-david-dean')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1961-1968</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'rogers-william-pierce')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1969-1973</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'kissinger-henry-a')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1973-1977</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'vance-cyrus-roberts')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1977-1980</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'muskie-edmund-sixtus')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1980-1981</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'haig-alexander-meigs')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1981-1982</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'shultz-george-pratt')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1982-1989</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'baker-james-addison')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1989-1992</xsl:attribute>United States.
                ...
                <xsl:if
                    ...
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1992-1993</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'christopher-warren-minor')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1993-1997</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'albright-madeleine-korbel')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-1997-2001</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'powell-colin-luther')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2001-2005</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'rice-condoleezza')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2005-2009</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'clinton-hillary-rodham')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2009-2013</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'kerry-john-forbes')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2013-2017</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'tillerson-rex-wayne')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2017-2018</xsl:attribute>United States.
                ...
                <xsl:if test=".//tei:term[matches(attribute::xml:id, 'pompeo-mike')]">
                    <xsl:element name="term" namespace="http://www.tei-c.org/ns/1.0"><xsl:attribute
                            name="xml:id">secretary-of-state-2018-</xsl:attribute>United States.
