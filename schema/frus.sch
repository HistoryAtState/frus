<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt3"
    ...
    <pattern id="div-subtype-attribute-checks">
        ...
        <rule context="tei:div/@subtype">
            <assert
                test=". = ('about-frus-series', 'acknowledgements', 'additional-volumes', 'appendix', 'editorial-note', 'editorial-policies', 'errata', 'graphic-materials', 'historian-statement', 'historical-document', 'index', 'maps', 'note-on-covert-actions', 'notes', 'preface', 'press-release', 'referral', 'section', 'sources', 'subsection', 'table-of-contents', 'volume-summary')"
                ...
                historian-statement, historical-document, index, maps, note-on-covert-actions,
                notes, preface, press-release, referral, section, sources, subsection,
                table-of-contents, volume-summary</assert>
        </rule>
    </pattern>
