<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt3"
    ...
    <pattern id="div-subtype-attribute-checks">
        ...
        <rule context="tei:div/@subtype">
            <assert
                test=". = ('about-frus-series', 'acknowledgements', 'additional-volumes', 'appendix', 'editorial-note', 'editorial-policies', 'errata', 'graphic-materials', 'historian-statement', 'historical-document', 'index', 'maps', 'notes', 'preface', 'press-release', 'referral', 'sources', 'subsection', 'table-of-contents', 'volume-summary')"
                ...
                press-release, referral, sources, subsection, table-of-contents,
