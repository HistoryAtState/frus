<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ckbk="http://www.oreilly.com/XSLTCookbook" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:functx="http://www.functx.com">
    ...
    <pattern id="frus-attachment-checks">
        ...
        <rule context="frus:attachment">
            ...
            <assert test="not(.//tei:head = 'Editorial Note' or 'Editor’s Note')">Treat editorial notes as full documents, not as attachments</assert>
    ...
    <pattern id="dateline-date-checks">
        ...
        <rule context="tei:date[ancestor::tei:dateline and not(ancestor::frus:attachment)]
            [matches(., 'undated|not\s+dated|not\s+declassified', 'i')]">
